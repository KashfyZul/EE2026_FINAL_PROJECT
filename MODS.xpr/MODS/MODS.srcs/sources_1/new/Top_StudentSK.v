...
module Top_StudentSK (    
    ...
    reg [3:0] screen_state = 0; // which screen should i use (ie main or credits)
    reg reset = 0;
    reg pause = 0;
       
    wire clk625;
    flexy_clock clock6p25m (clk, 7, clk625);
    ...
    credits_screen screen0 (clk, btnD, btnR, pixel_index, screen_state, oled_data0, credits_next_screen);
    main_menu_screen screen1 (clk, btnU, btnD, btnR, pixel_index, screen_state, oled_data1, main_next_screen);
    character_screen screen2 (clk, btnU, btnD, btnL, btnR, pixel_index, screen_state, oled_data2, character_next_screen);
    game_screen screen3 (clk, btnU, btnD, btnL, btnR, btnC, pixel_index, screen_state, oled_data3, game_next_screen, 
